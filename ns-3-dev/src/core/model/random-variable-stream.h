...
public:
  ...
  /**
   * \brief Get the current MRG32k3a PRNG internal state (6 doubles).
   * \param [out] state Array of 6 doubles to receive the state.
   */
  void GetRngState (double state[6]) const;
